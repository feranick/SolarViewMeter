...
//*****************************************************************************
 ...
 v. 1.9beta - Display current performance of a solar cell
...
String versProg = "1.9beta";
String versDate = "20111102";
...
int numFixedRes = 7;  //Number of fixed resistors

#ifdef MEGA 
const int Tr[]= {38, 39, 40, 41, 42, 43, 44};  //transistor ports for fixed resistors
#else
const int Tr[]= {12, 11, 10, 9, 8, 7, 6};  //transistor ports for fixed resistors
#endif
...
int digitalPotWriteI2C(int address, byte a1, int value) {
  ...
  Wire.write(a1);            // sends instruction byte  
